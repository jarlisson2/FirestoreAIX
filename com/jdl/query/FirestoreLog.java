...
public class FirestoreLog {
  ...
  public static void setLogLevel(String logLevel) {
    FirestoreLog.w("FirestoreJDL", "Setting log level to : " + logLevel);
    switch(logLevel.toLowerCase()) {
      ...
      case "warning":
        ...
        break;
      default:
        FirestoreLog.e("FirestoreJDL", "New logLevel unknown, leaving previous setting : " + _logLevel);
        break;
    }

    FirestoreLog.d("FirestoreJDL", "New logLevel : " + _logLevel);
  }
